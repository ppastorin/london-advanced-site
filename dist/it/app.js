  ...
  if (!site.innerHTML.trim()) site.innerHTML = `<main id="top">
    ...
    <section class="hero">
      <div class="hero-intro">
        <span class="eyebrow">Guida indipendente di Londra · 5 strumenti gratuiti</span>
    ...
    <section id="tools" class="tools section-wrap">
      <div class="section-heading tool-heading"><div><span>01 / Londra pratica</span><h2>Scegli ciò che ti serve adesso.</h2></div><p>Cinque strumenti mirati. Nessun account, nessuna app da scaricare e nessun consiglio generico.</p></div>
